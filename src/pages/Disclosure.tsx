        ...
        <div className="container mx-auto px-6 md:px-8 max-w-4xl legal-body">
          ...
          <div className="space-y-14 animate-on-scroll">
            ...
            <div className="space-y-4">
              ...
              <p className="text-base text-muted-foreground leading-[2] font-sans">Multi Investment Holding SA is a family office and private investment firm incorporated under the laws of Switzerland, with its registered office at Chemin Rieu 12, 1208 Genève. The company is registered in the Swiss Commercial Register under number CH-660.0.567.024-5, and its VAT number is CHE-396.944.369. Founded in 2024, we manage and advise on investments across multiple asset classes — including private equity, real estate, venture capital, and public markets — on behalf of the Aponte family and select institutional partners. Our investment philosophy combines long-term value creation with disciplined risk management, drawing on the Aponte family's multi-generational experience in building and operating global enterprises.</p>
            </div>
