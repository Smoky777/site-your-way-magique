...
const leadership = [
  ...
  { name: "Thomas Blum", role: "Chief Investment Officer", abbr: "CIO", bio: "Responsible for portfolio strategy, asset allocation, and investment thesis across all verticals.", icon: TrendingUp },
